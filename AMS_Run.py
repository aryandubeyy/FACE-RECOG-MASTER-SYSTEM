...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\Users\Lenovo\Desktop\Attendace_management_system-master\Attendance\Manually Attendance\OOP_2019_02_22_Time_11_32_41.csv"')
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            detector = cv2.CascadeClassifier(r"C:\Users\Lenovo\Desktop\Attendace_management_system-master\haarcascade_frontalface_default.xml")
            Enrollment = txt.get()
            Name = txt2.get()
            sampleNum = 0
            while (True):
                ...
                for (x, y, w, h) in faces:
                    ...
                    cv2.imwrite(r"C:\Users\Lenovo\Desktop\Attendace_management_system-master\TrainingImage/" + Name + "." + Enrollment + '.' + str(sampleNum) + ".jpg",
                                gray[y:y + h, x:x + w])
            ...
            with open(r'C:\Users\Lenovo\Desktop\Attendace_management_system-master\StudentDetails\StudentDetails.csv', 'a+') as csvFile:
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    recognizer.read(r"C:\Users\Lenovo\Desktop\Attendace_management_system-master\TrainingImageLabel\Trainner.yml")
                except:
                    e = 'Model not found,Please train model'
                    Notifica.configure(text=e, bg="red", fg="black", width=33, font=('times', 15, 'bold'))
                    Notifica.place(x=20, y=250)

                harcascadePath = r"C:\Users\Lenovo\Desktop\Attendace_management_system-master\haarcascade_frontalface_default.xml"
                faceCascade = cv2.CascadeClassifier(harcascadePath)
                df = pd.read_csv(r"C:\Users\Lenovo\Desktop\Attendace_management_system-master\StudentDetails\StudentDetails.csv")
                cam = cv2.VideoCapture(0)
                ...
                timeStamp = datetime.datetime.fromtimestamp(ts).strftime('%H:%M:%S')
                Hour, Minute, Second = timeStamp.split(":")
                fileName =r"C:\Users\Lenovo\Desktop\Attendace_management_system-master\Attendance/" + Subject + "_" + date + "_" + Hour + "-" + Minute + "-" + Second + ".csv"
                attendance = attendance.drop_duplicates(['Enrollment'], keep='first')
                print(attendance)
                ...
                root.configure(background='snow')
                cs = r"C:\Users\Lenovo\Desktop\Attendace_management_system-master\Attendance/" + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\Users\Lenovo\Desktop\Attendace_management_system-master\Attendance\PHP_2024-05-05_14-33-44.csv"')
    ...
    def log_in():
        ...
        if username == 'kushal' :
            if password == 'kushal14320':
                ...
                cs = r"C:\Users\Lenovo\Desktop\Attendace_management_system-master\StudentDetails\StudentDetails.csv"
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
def trainimg():
    ...
    try:
        global faces,Id
        faces, Id = getImagesAndLabels(r"C:\Users\Lenovo\Desktop\Attendace_management_system-master\TrainingImage")
    except Exception as e:
        l=r"C:\Users\Lenovo\Desktop\Attendace_management_system-master\TrainingImage"
        Notification.configure(text=l, bg="SpringGreen3", width=50, font=('times', 18, 'bold'))
        Notification.place(x=350, y=400)

    recognizer.train(faces, np.array(Id))
    try:
        recognizer.save(r"C:\Users\Lenovo\Desktop\Attendace_management_system-master\TrainingImageLabel\Trainner.yml")
    except Exception as e:
        q=r"C:\Users\Lenovo\Desktop\Attendace_management_system-master\TrainingImageLabel"
...
FA = tk.Button(window, text="Automatic Attendance",fg="white",command=subjectchoose  ,bg="blue2"  ,width=20  ,height=3, activebackground = "Red" ,font=('times', 15, ' bold '))
